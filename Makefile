...
SRCS = 	main.c \
		...
		parser/light_parsing.c \
		parser/shape_parsing.c \
		parser/utils.c \
		parser/vector_utils.c \
		${LIB_SRC}
...
${NAME}: ${OBJS}
	make -C ./libft
	${CC} $(OBJS) -lm -lmlx -framework OpenGL -framework AppKit -o $(NAME) libft/libft.a

%.o: %.c
	${CC} ${CFLAGS} -Imlx -o ${@} -c ${@:.o=.c}
